...
Sou educadora e estou em transição de carreira para desenvolvimento de software, com foco em Back-end.
Atualmente tenho buscado compreender a integração entre back e front através da criação e consumo de APIs REST utilizando React.
...
### Possuo certificação nos seguintes conhecimentos técnicos:
...
💪 Estou aberta a oportunidades como desenvolvedora júnior, aprendizado contínuo e colaborações em projetos de tecnologia.
